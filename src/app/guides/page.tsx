        ...
        content: (
          <div className="space-y-6">
            <p className="leading-relaxed">
              BTCPayServer Companion is a powerful desktop application that
              enhances your BTCPayServer experience with advanced analytics,
              plugin management, and offline capabilities.
            </p>
            <p className="leading-relaxed">
              This guide will walk you through the initial setup and help you
              understand the core features of the companion app.
            </p>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <p>
              BTCPayServer Companion is available for Windows, macOS, and Linux.
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>
                Windows 10 or later / macOS 10.15 or later / Ubuntu 20.04 or
                later
              </li>
        ...
        content: (
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-3">
              <li>
                <strong>Navigate to Settings:</strong> Click on the Settings
                link in the sidebar or go to the Settings page
              </li>
              <li>
                <strong>Enter BTCPayServer URL:</strong> Input your BTCPayServer
                instance URL (e.g., https://btcpay.yourdomain.com)
              </li>
              <li>
                <strong>Add API Key:</strong> Generate an API key from your
                BTCPayServer dashboard with the following permissions:
              ...
              <li>
                <strong>Select Store:</strong> Choose the store you want to
                connect to from the dropdown
              </li>
              <li>
            ...
            <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-950/30">
              <p className="text-sm leading-relaxed">
                <strong className="font-semibold">Tip:</strong> You can work in
                offline mode without a BTCPayServer connection. The app will use
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  <h5 className="font-semibold">
                    Enable Financial Analysis App
                  </h5>
                  <p className="text-sm text-muted-foreground">
                    Go to Apps and enable the Financial Analysis plugin to start
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Set up multiple stores if needed and configure monthly
                    expenses for profit calculations
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Check your dashboard for an overview of your BTCPayServer
    ...
    sections: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Apps (also called plugins) extend the functionality of
              BTCPayServer Companion. They run in a secure, sandboxed
              environment and can access BTCPayServer data through a controlled
              API.
            </p>
            <p>
              The companion app comes with several built-in apps and supports
            ...
            <div className="space-y-3">
              <div className="rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Comprehensive revenue analytics, profit calculations, and
                  financial projections. Track payment methods, monitor trends,
                  and export reports.
                </p>
              </div>
              ...
              <div className="rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  QR code-based event management system. Scan tickets, track
                  attendance, and manage event entry with offline support.
                </p>
              </div>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <ol className="list-decimal list-inside space-y-3">
              <li>
                <strong>Navigate to Apps:</strong> Click on "Apps" in the
                sidebar
              </li>
              <li>
                <strong>Find the App:</strong> Browse the available apps in the
                grid
              </li>
              <li>
                <strong>Enable the App:</strong> Toggle the switch on the app
                card to enable it
              </li>
              <li>
                <strong>Access the App:</strong> Enabled apps appear in the
                sidebar for quick access
              </li>
              <li>
                <strong>Configure Settings:</strong> Click the settings icon on
                the app card to configure app-specific settings
              </li>
            </ol>

            <div className="mt-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900 dark:bg-yellow-950/30">
              <p className="text-sm leading-relaxed">
                <strong className="font-semibold">Note:</strong> Some apps may
                require additional configuration, such as API permissions or
                store selection, before they can be fully functional.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-3">
              <li>
                <strong>Prepare the Plugin:</strong> Ensure your plugin is
                packaged as a ZIP file with a valid manifest.json
              </li>
              <li>
                <strong>Upload the Plugin:</strong> On the Apps page, click
                "Upload Plugin" or drag and drop the ZIP file
              </li>
              <li>
                <strong>Security Scan:</strong> The plugin will be automatically
                scanned for security issues
              </li>
              <li>
                <strong>Review Permissions:</strong> Check what permissions the
                plugin requests
              </li>
              <li>
                <strong>Install:</strong> If the scan passes, the plugin will be
            ...
            <div className="mt-6 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-900 dark:bg-red-950/30">
              <p className="text-sm leading-relaxed">
                <strong className="font-semibold">Warning:</strong> Only install
                plugins from trusted sources. Malicious plugins could
                potentially access your BTCPayServer data.
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <strong>Disable/Enable:</strong> Toggle apps on/off without
                uninstalling
              </li>
              <li>
                <strong>Configure:</strong> Access app-specific settings through
                the settings icon
              </li>
              <li>
                <strong>Update:</strong> When updates are available, you'll see
                an update button on the app card
              </li>
              <li>
                <strong>Uninstall:</strong> Remove apps you no longer need
            ...
            <p className="text-sm">
              Apps store data locally using IndexedDB. You can clear app data
              from the app's settings page if you need to reset an app or free
              up space.
            </p>
          </div>
        ),
    ...
    sections: [
        ...
        content: (
          <div className="space-y-4">
            <p>
              ...
              protect your BTCPayServer instance and cryptocurrency operations
              from potentially malicious plugins.
            </p>
            <p>
              Our security model is based on the principle of least privilege -
              plugins only get access to what they explicitly need and nothing
              more.
            </p>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              All plugins run in isolated sandbox environments using iframes
              with strict Content Security Policies (CSP).
            </p>

            <h4 className="font-semibold">Sandbox Restrictions</h4>
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>
                No direct access to the main application's JavaScript context
              </li>
              <li>No access to cookies or local storage of the main app</li>
              <li>
                No ability to make direct network requests without permission
              </li>
              <li>No access to file system or native APIs</li>
              <li>
                All communication happens through a controlled message-passing
                API
              </li>
            </ul>
            ...
            <div className="mt-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-900 dark:bg-green-950/30">
              <p className="text-sm leading-relaxed">
                <strong className="font-semibold">Result:</strong> Even if a
                plugin contains malicious code, it cannot access your
                BTCPayServer API keys, cryptocurrency wallets, or sensitive
                data.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Plugins must declare required permissions in their manifest file.
              Users can review these permissions before installation.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border bg-muted/30 p-4">
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                  Create and modify BTCPayServer resources (requires additional
                  confirmation)
                </p>
              </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Before installation, all plugins are automatically scanned for
              suspicious patterns and potentially malicious code.
            </p>

            <h4 className="font-semibold">What We Scan For</h4>
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>
                Attempts to access sensitive APIs (crypto, filesystem, etc.)
              </li>
            ...
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
              <p className="text-sm">
                <strong>Transparency:</strong> Scan results are shown before
                installation, including any warnings or concerns found.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Even after installation, plugins are continuously monitored for
              suspicious behavior.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-4 rounded-lg bg-muted/20 p-4">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground mt-1">
                    CPU and memory usage is monitored to detect mining or DoS
                    attempts
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 rounded-lg bg-muted/20 p-4">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground mt-1">
                    Plugins exhibiting malicious behavior are automatically
                    disabled
                  </p>
                </div>
              </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-3">
              <li>
                <strong>Verify Plugin Sources:</strong> Only install plugins
                from trusted developers or official sources
              </li>
              <li>
                <strong>Review Permissions:</strong> Always check what
                permissions a plugin requests before installation
              </li>
              <li>
                <strong>Keep Updated:</strong> Update BTCPayServer Companion and
                plugins regularly for security patches
              </li>
              <li>
                <strong>Monitor Activity:</strong> Regularly check the security
                dashboard for any warnings
              </li>
              <li>
                <strong>Limit Permissions:</strong> Only grant plugins the
                minimum permissions they need
              </li>
              <li>
                <strong>Remove Unused Plugins:</strong> Uninstall plugins you're
                no longer using
              </li>
              <li>
                <strong>Report Suspicious Behavior:</strong> If you notice
                anything unusual, disable the plugin and report it
              </li>
            </ol>

            <div className="mt-8 rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-900 dark:bg-purple-950/30">
              <p className="text-sm leading-relaxed">
                <strong className="font-semibold">Remember:</strong> Security is
                a shared responsibility. While we provide robust protection
                mechanisms, your vigilance in following best practices is
                equally important.
              </p>
            </div>
          </div>
    ...
    sections: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              BTCPayServer Companion supports custom plugins, allowing you to
              extend functionality to meet your specific business needs.
            </p>
            <p>
              Plugins are built using standard web technologies (HTML, CSS,
              JavaScript/TypeScript) and can use popular frameworks like React,
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              A plugin consists of the following files packaged in a ZIP
              archive:
            </p>
  ...
  "icon": "assets/icon.png"
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Plugins communicate with BTCPayServer Companion through a
              message-passing API.
            </p>
...
window.btcpayCompanion.ui.showNotification({
  ...
  type: 'success'
            ...
            <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg">
              <p className="text-sm">
                <strong>API Documentation:</strong> Full API documentation with
                all available methods and examples is available in our GitHub
                repository.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-3">
              <li>
                <strong>Use the Plugin Template:</strong> Clone our plugin
                template from GitHub as a starting point
              </li>
              <li>
                <strong>Install Dependencies:</strong>
                <pre className="bg-muted/50 border border-border p-3 rounded-lg mt-2 text-sm font-mono">
                  npm install
                </pre>
              </li>
              <li>
              ...
              <li>
                <strong>Test in Companion App:</strong> Use the development mode
                to load your plugin locally
              </li>
            </ol>
            ...
            <ol className="list-decimal list-inside space-y-3">
              ...
              <li>
                <strong>Test Installation:</strong> Upload the ZIP file to
                verify it installs correctly
              </li>
              <li>
                <strong>Distribute:</strong> Share your plugin ZIP file or
        ...
        content: (
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              ...
              <li>
                Test thoroughly in different scenarios (online/offline,
                different data sets)
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              ...
              <li>
                Respect user preferences (dark mode, currency display, etc.)
              </li>
            </ul>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Once your plugin is ready, you can share it with the community:
            </p>

            <h4 className="font-semibold">Community Repository</h4>
            <p className="text-sm">
              Submit your plugin to the official BTCPayServer Companion plugin
              repository. Plugins in the repository are reviewed for security
              and quality.
            </p>
            ...
            <p className="text-sm">
              You can also distribute your plugin ZIP file directly to users.
              They can install it using the "Upload Plugin" feature in the Apps
              page.
            </p>
            ...
            <div className="mt-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-900 dark:bg-green-950/30">
              <p className="text-sm leading-relaxed">
                ...
                Consider making your plugin open source to build trust and allow
