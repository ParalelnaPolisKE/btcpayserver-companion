...
export function ProjectionChart({
  ...
  const { historical, projections, trend, primaryCurrency, exchangeRate } =
    data;
  ...
  const allValues = [
    ...combinedData.map((d) => d.revenue || d.projection || 0),
    convertedExpenses,
  ];
                  ...
                  return (
                    <div className="bg-background p-3 border rounded-md shadow-md">
                      <p className="font-semibold mb-2">
                        {formatXAxisTick(label as string)}
                      </p>
                      ...
                      <div className="mt-2 pt-2 border-t">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {(payload[0]?.value || 0) > convertedExpenses
                            ? "✓ Above expenses"
                            : "✗ Below expenses"}
                        </p>
                      </div>
